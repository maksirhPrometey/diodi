...
def home_view(request):
    ...
    context = {
        ...
        **seo_context(home_page),
        'home_page': home_page,
        'benefits_title': home_page.benefits_title if home_page else '',
        'benefits_lead': home_page.benefits_lead if home_page else '',
        'benefits': home_benefits_from_intro(home_page.intro_text if home_page else ''),
